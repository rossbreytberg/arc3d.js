...
Arc3d.World = function(container, options) {
  ...
  function init () {
    ...
    var earthTexture = THREE.ImageUtils.loadTexture('./images/earthsmall.jpg');
    var earthTextureSpec = THREE.ImageUtils.loadTexture('./images/earthspecsmall.jpg');
    var earthTextureBump = THREE.ImageUtils.loadTexture('./images/earthbumpsmall.jpg');
